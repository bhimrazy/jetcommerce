            ...
            <ul className="flex flex-row items-center ">                    
                    <li className="px-3 xl:px-4 hidden md:block">
                        <div className="relative">
                            ...
                            <svg className="w-6 h-6 text-gray-400 absolute inset-3 hover:text-gray-500 transition-all duration-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                        </div>
                    </li>
