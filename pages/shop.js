      ...
      <div className="flex flex-col font-inter antialiased bg-gray-50 items-center min-h-screen">
            ...
            <ul className="flex flex-row items-center ">
                    ...
                    <li className="px-3 xl:px-4 hidden md:block">
                        <label className="relative">
                            ...
                            <svg className="w-6 h-6 text-gray-400 absolute" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                        </label>
                    </li>
       ...
       <footer className=" w-full bg-white shadow-sm py-20">
            <div className=" lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl px-8  flex flex-col w-full items-center mx-auto space-y-16">
                <div className="grid md:grid-cols-6 sm:grid-cols-1 text-left text-gray-600 text-normal ">
                    <div className="">
                        <img className="w-10 h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="logo" />
                    </div>
                    ...
                    <div className="flex flex-col col-span-2 space-y-2 md:space-y-4">
                        ...
                        <div className="flex flex-row space-x-4">
                            ...
                            <button className="focus:outline-none px-4 -y-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 whitespace-nowrap text-white text-lg">Sign up</button>
                        </div>                        
                    </div>
                </div>
                <div className=" text-lg text-gray-600"><p>© 2021. Clothing Co. Ltd. All rights reserved.</p></div>
            </div>
       </footer>
      </div>
    );
