...
export default function Header() {
  return (
    <header className="max-w-7xl container mx-auto flex flex-col space-y-2">
      <Topbar />
      <div className="border-b pb-6 pt-3 px-10 flex  flex-wrap space-y-2 flex-row items-center justify-between">
        ...
        <div className="order-2 w-full lg:order-none border border-yellow-500  lg:w-96 justify-between py-1 rounded-full flex flex-row items-center">
